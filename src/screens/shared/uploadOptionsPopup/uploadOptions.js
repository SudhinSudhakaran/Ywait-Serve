    ...
    <View style={styles.container}>
      ...
      <View style={styles.itemsContainer}>
          ...
          <View style={styles.items}>
            <Image
              style={{
               ...
               height:  isTablet===true?30:24, 
               tintColor: Colors.PRIMARY_COLOR}}
              source={Images.GALLERY_ICON}
            />
            <Text style={[styles.itemText,{fontSize: isTablet===true?18:14}]}>{t(Translations.GALLERY)}</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          style={{marginTop: 16}}
          ...
          <View style={styles.items}>
            ...
            />
            <Text style={[styles.itemText,{fontSize: isTablet===true?18:14}]}>{t(Translations.CAMERA)}</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.cancelText, {color: Colors.SECONDARY_COLOR,fontSize: isTablet===true?20:14}]}>
