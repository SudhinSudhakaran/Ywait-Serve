...
const AppointmentReschedulePopup = props => {
  ...
  return (
    <View
      ...
      <Text
        ...
        {t(Translations.CONFIRM_RESCHEDULE)}
      </Text>
      ...
      <View style={{marginTop: 20, flexDirection: 'row'}}>
        <GetImage
          ...
          fullName={(
            (props.selectedAppointment.customer_id?.firstName || 'N/A') +
            ' ' +
            (props.selectedAppointment.customer_id?.lastName || '')
          ).trim()}
          url={props.selectedAppointment.customer_id?.image}
        />
        <View style={{flexDirection: 'column'}}>
          <Text
            ...
            {props.selectedAppointment.customer_id?.firstName}{' '}
            {props.selectedAppointment.customer_id?.lastName}
          </Text>
          <Text
            style={{
      ...
      <View style={{flex: 1}} />
      {Globals.BUSINESS_DETAILS.enableCancellationFee  && Globals.BUSINESS_DETAILS.enableRescheduleFee ? (
        <Text
          style={{
            fontFamily: Fonts.Gibson_Regular,
            fontSize: 14,
        ...
        <Text
          ...
          {t(Translations.ARE_YOU_SURE_TO_RESCHEDULE_THIS_APPOINTMENT)}{' '}
        </Text>
      )}
      <View
...
export default AppointmentReschedulePopup;
