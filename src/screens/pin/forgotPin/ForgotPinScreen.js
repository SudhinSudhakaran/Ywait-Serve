...
const ForgotPinScreen = () => {
  ...
  const performForgotPinEmail = () => {
    ...
    DataManager.performForgotPinEmail(body).then(
      ...
      <View
        ...
        <InputScrollView
          ...
          <Text
            ...
            numberOfLines={3}>
            {t(Translations.FORGOT_PIN_DESCRIPTION)}
          </Text>
